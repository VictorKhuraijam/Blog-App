   ...
   <Container>
    ...
    <div className="bg-white shadow-md rounded-lg p-4 flex flex-col items-center">
      ...
      <div className="relative">
        <img
          src={user?.imageId ? appwriteService.getProfilePicturePreview(user.imageId) : '/assets/profile-placeholder.svg'}
          alt="profile"
      ...
      <div className="mt-4 text-center">
        ...
        <p className="text-sm text-gray-700 mt-2">{user?.bio || 'No bio available'}</p>
      </div>
